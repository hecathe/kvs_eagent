...
import _sfc_main$9 from './svg-icon-256de3ee.mjs';
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_svg_icon = _sfc_main$9;
  const _component_NuxtLink = __nuxt_component_0$2;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "header-nav-top" }, _attrs))} data-v-64a1171f><!--[-->`);
  ssrRenderList($props.menuHeader, (item) => {
    _push(`<li class="header-nav-top__item" data-v-64a1171f>`);
    if (item.icon) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="" data-v-64a1171f${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0,
  ...
  _push(`</li><li class="header-nav-top__item" data-v-64a1171f>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "https://t.me/eagentkvs",
    target: "_blank",
    class: "header-nav-top__link"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_1)} alt="" data-v-64a1171f${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_1,
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-64a1171f"]]);
const _sfc_main$3 = {
  props: {
    template: {
      type: Object,
...
//# sourceMappingURL=default-f66768bb.mjs.map
